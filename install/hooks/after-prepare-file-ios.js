...
const IOS_FILE_PATH = 'platforms/ios/www/nodejs-project';
...
module.exports = function(context) {
  ...
  fs.copyFileSync(path.join(SOURCE_FILE_DIR,MAIN_FILE), path.join(IOS_FILE_PATH,MAIN_FILE)); 
  fs.copyFileSync(path.join(SOURCE_FILE_DIR,RUNNODEBACK_FILE), path.join(IOS_FILE_PATH,RUNNODEBACK_FILE)); 
}